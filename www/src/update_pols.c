...
static int select_callback(void *data,int argc,char **argv,char **azColName)
{
	...
	{
		strcpy(sql_pols[0].id,		argv[0] ? argv[0] : "");
		strcpy(sql_pols[0].polid,	argv[1] ? argv[1] : "");
		strcpy(sql_pols[0].polname,	argv[2] ? argv[2] : "");
		strcpy(sql_pols[0].upvalue,	argv[3] ? argv[3] : "");
		strcpy(sql_pols[0].lowvalue,	argv[4] ? argv[4] : "");
		strcpy(sql_pols[0].unit,	argv[5] ? argv[5] : "");
		strcpy(sql_pols[0].isstat,	argv[6] ? argv[6] : "");
		strcpy(sql_pols[0].poltype,	argv[7] ? argv[7] : "");
	}
...
static void show_update(void)
{
	...
	printf("<td width=\"13%%\" align=\"right\" nowrap=\"nowrap\" bgcolor=\"#f1f1f1\">仪器编号：</td>\n");
	printf("<td><input type=\"text\" name=\"update_polid\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"*1-12\" nullmsg=\"请输入仪器编号！\" errormsg=\"仪器编号1-12任意字符!\" /></td>\n",sql_pols[0].polid);
        printf("<td>\n");

        printf("<div class=\"info\"><span class=\"Validform_checktip\">仪器编号1-12任意字符!</span> \
			<span class=\"dec\"><s class=\"dec1\">&#9670;</s><s class=\"dec2\">&#9670;</s></span></div>\n");
        printf("</td>\n");
	printf("</tr>\n");
	printf("</table>\n");
	...
	printf("<td><input type=\"text\" name=\"update_unit\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
	...
	printf("<td><input type=\"text\" name=\"update_isstat\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
	...
	printf("<td><input type=\"text\" name=\"update_poltype\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
