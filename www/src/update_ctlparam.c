...
static CTLPARAM sql_ctlparam[1];
...
static int select_callback(void *data,int argc,char **argv,char **azColName)
{
	...
	{
		strcpy(sql_ctlparam[0].id,		argv[0] ? argv[0] : "");
		strcpy(sql_ctlparam[0].sbid,		argv[1] ? argv[1] : "");
		strcpy(sql_ctlparam[0].paramname,	argv[2] ? argv[2] : "");
		strcpy(sql_ctlparam[0].devname,		argv[3] ? argv[3] : "");
		strcpy(sql_ctlparam[0].devaddr,		argv[4] ? argv[4] : "");
		strcpy(sql_ctlparam[0].funcode,		argv[5] ? argv[5] : "");
		strcpy(sql_ctlparam[0].datatype,	argv[6] ? argv[6] : "");
		strcpy(sql_ctlparam[0].regaddr,		argv[7] ? argv[7] : "");
		strcpy(sql_ctlparam[0].reglen,		argv[8] ? argv[8] : "");
		strcpy(sql_ctlparam[0].databit,		argv[9] ? argv[9] : "");
	}
...
static int select_table(int n)
{
	...
	snprintf(sql,sizeof(sql),"SELECT id,sbid,paramname,devname,devaddr,funcode,datatype,regaddr,reglen,\
			databit FROM %s where ID = %d ;",TABLENAME,n);
