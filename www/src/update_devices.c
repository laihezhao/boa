...
static int close_database(void)
{
	...
	if (ret != SQLITE_OK) {
		fprintf(stderr,"close database failure\n");
		return -1;
	}
...
static int select_callback(void *data,int argc,char **argv,char **azColName)
{
	...
	{
		strcpy(sql_devices[0].id,	  argv[0] ? argv[0] : "");
		strcpy(sql_devices[0].devname,    argv[1] ? argv[1] : "");
		strcpy(sql_devices[0].devtype,    argv[2] ? argv[2] : "");
		strcpy(sql_devices[0].devaddr,    argv[3] ? argv[3] : "");
		strcpy(sql_devices[0].comtype,    argv[4] ? argv[4] : "");
		strcpy(sql_devices[0].port,	  argv[5] ? argv[5] : "");
		strcpy(sql_devices[0].baud,       argv[6] ? argv[6] : "");
		strcpy(sql_devices[0].databits,   argv[7] ? argv[7] : "");
		strcpy(sql_devices[0].stopbits,   argv[8] ? argv[8] : "");
		strcpy(sql_devices[0].parit,	  argv[9] ? argv[9] : "");
	}
...
static void show_update(void)
{
	...
	printf("<td><input type=\"text\" name=\"update_devname\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"*1-30\" nullmsg=\"请输入通信！\" errormsg=\"通信名称!\" /></td>\n",sql_devices[0].devname);
        printf("<td>\n");
	...
	printf("<td><input type=\"text\" name=\"update_devtype\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"n1-10\" nullmsg=\"请输入通信类型！\" errormsg=\"通信类型1-10位数字！\" /></td>\n",sql_devices[0].devtype);
        printf("<td>\n");
        printf("<div class=\"info\"><span class=\"Validform_checktip\">通信类型1-10位数字！</span> \
			<span class=\"dec\"><s class=\"dec1\">&#9670;</s><s class=\"dec2\">&#9670;</s></span></div>\n");
        printf("</td>\n");
	...
	printf("<td><input type=\"text\" name=\"update_devaddr\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"n1-5\" nullmsg=\"请输入通信地址！\" errormsg=\"通信地址!\" /></td>\n",sql_devices[0].devaddr);
        printf("<td>\n");
	...
	printf("<table class=\"table table-bordered\" style=\"margin-bottom:0px;\">\n");
	printf("<tr>\n");
	printf("<td width=\"13%%\" align=\"right\" nowrap=\"nowrap\" bgcolor=\"#f1f1f1\">通信方式：</td>\n");
	printf("<td><input type=\"text\" name=\"update_comtype\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"n1-1\" nullmsg=\"请输入通信方式！\" errormsg=\"通信方式！\" /></td>\n",sql_devices[0].comtype);
        printf("<td>\n");
        printf("<div class=\"info\"><span class=\"Validform_checktip\">通信方式！</span> \
			<span class=\"dec\"><s class=\"dec1\">&#9670;</s><s class=\"dec2\">&#9670;</s></span></div>\n");
        printf("</td>\n");
	...
	printf("<td><input type=\"text\" name=\"update_port\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"n1-1\" nullmsg=\"请输入端口！\" errormsg=\"端口!\" /></td>\n",sql_devices[0].port);
        printf("<td>\n");
        printf("<div class=\"info\"><span class=\"Validform_checktip\">端口!</span> \
			<span class=\"dec\"><s class=\"dec1\">&#9670;</s><s class=\"dec2\">&#9670;</s></span></div>\n");
        printf("</td>\n");
	printf("</tr>\n");
	printf("</table>\n");
	...
	printf("<td><input type=\"text\" name=\"update_baud\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"n1-10\" nullmsg=\"请输入波特率！\" errormsg=\"波特率！\" /></td>\n",sql_devices[0].baud);
        printf("<td>\n");
        printf("<div class=\"info\"><span class=\"Validform_checktip\">波特率！</span><span class=\"dec\"> \
			<s class=\"dec1\">&#9670;</s><s class=\"dec2\">&#9670;</s></span></div>\n");
        printf("</td>\n");
	printf("<td width=\"13%%\" align=\"right\" nowrap=\"nowrap\" bgcolor=\"#f1f1f1\">数据位：</td>\n");
	printf("<td><input type=\"text\" name=\"update_databits\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"n1-1\" nullmsg=\"请输入数据位！\" errormsg=\"数据位!\" /></td>\n",sql_devices[0].databits);
        printf("<td>\n");
	...
	printf("<td><input type=\"text\" name=\"update_stopbits\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"n1-1\" nullmsg=\"请输入停止位！\" errormsg=\"停止位！\" /></td>\n",sql_devices[0].stopbits);
        printf("<td>\n");
        printf("<div class=\"info\"><span class=\"Validform_checktip\">停止位！</span> \
			<span class=\"dec\"><s class=\"dec1\">&#9670;</s><s class=\"dec2\">&#9670;</s></span></div>\n");
        printf("</td>\n");
	printf("<td width=\"13%%\" align=\"right\" nowrap=\"nowrap\" bgcolor=\"#f1f1f1\">奇偶校验：</td>\n");
	printf("<td><input type=\"text\" name=\"update_parit\" style=\"width:110px;\" value=\"%s\" class=\"inputxt\" \
			datatype=\"s1-1\" nullmsg=\"请输入奇偶校验！\" errormsg=\"奇偶校验!\" /></td>\n",sql_devices[0].parit);
        printf("<td>\n");
        printf("<div class=\"info\"><span class=\"Validform_checktip\">奇偶校验!</span> \
			<span class=\"dec\"><s class=\"dec1\">&#9670;</s><s class=\"dec2\">&#9670;</s></span></div>\n");
        printf("</td>\n");
	printf("</tr>\n");
	printf("</table>\n");
