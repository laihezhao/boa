...
function dialogurl(e, url, tourl) {
    var bleft = ($(window).width() - 850) / 2;
    var btop = ($(window).height() - 450) / 2;
    ...
    p += 'dialogWidth:' + 850 + 'px;';
    p += 'dialogHeight:' + 450 + 'px;';
    p += 'dialogLeft:' + left + 'px;';
    p += 'dialogTop:' + top + 'px;';
    var returnValue = window.showModalDialog(url, "", p);
